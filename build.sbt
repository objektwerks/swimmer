...
// Begin: Client Assembly
  ...
  */
  ...
  if (OS == "mac") assemblyJarName := "swimmer-mac-0.11.jar"
  else if (OS == "mac-aarch64") assemblyJarName := "swimmer-m1-0.11.jar"
  else if (OS == "win") assemblyJarName := "swimmer-win-0.11.jar"
  else if (OS == "linux") assemblyJarName := "swimmer-linux-0.11.jar"
  else assemblyJarName := "swimmer-no-valid-target-specified-0.11.jar"
