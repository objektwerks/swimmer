...
export POOL_BALANCE_POSTGRESQL_POOL_INITIAL_SIZE=9
export POOL_BALANCE_POSTGRESQL_POOL_MAX_SIZE=32
export POOL_BALANCE_POSTGRESQL_POOL_CONNECTION_TIMEOUT_MILLIS=30000
