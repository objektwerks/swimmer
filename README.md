...
1. java -jar .assembly/swimmer-mac-0.20.jar
2. java -jar .assembly/swimmer-m1-0.20.jar
3. java -jar .assembly/swimmer-win-0.20.jar
4. java -jar .assembly/swimmer-linux-0.20.jar
